...
CXXFLAGS      = -pipe -std=c++11 -g -D_REENTRANT -Wall -W -fPIC $(DEFINES)
...
distdir: FORCE
	...
	$(COPY_FILE) --parents About.h Blowfish.h editProperties.h groupProperties.h groups.h HashEncode.h HashingAlgorithm.h HashingFactory.h IHashing.h MainWindow.h Md5.h models.h myLibb.h pathfile.h Settings.h sha256.h sha512.h userproperties.h users.h $(DISTDIR)/
	$(COPY_FILE) --parents About.cpp Blowfish.cpp editProperties.cpp groupProperties.cpp groups.cpp HashEncode.cpp HashingAlgorithm.cpp HashingFactory.cpp main.cpp MainWindow.cpp Md5.cpp models.cpp myLibb.cpp Settings.cpp sha256.cpp sha512.cpp userproperties.cpp users.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++11 -g -dM -E -o moc_predefs.h /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/data/dummy.cpp
