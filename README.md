...
to apt install qt4-default.Then if installed, it will first remove qt5-default, but dont 
...
just do apt install qt5-default and it will only remove the qt4-default package.
