######################################################################
# Automatically generated by qmake (3.1) Thu Jun 25 13:20:49 2020
######################################################################
...
QMAKE_CXXFLAGS += -std=c++11 -O2 -fstack-protector-strong -Wformat -Werror=format-security
QMAKE_CPPFLAGS += -Wdate-time -D_FORTIFY_SOURCE=2
QMAKE_CFLAGS += -O2 -fstack-protector-strong -Wformat -Werror=format-security
LDFLAGS += -Wl,-z,relro
CONFIG += qt debug
QMAKE_LIBS += -lcrypt
QT += widgets
